...
function _s_scripts() {
	...
	wp_enqueue_script( '_s-plugins', get_template_directory_uri() . '/assets/js/plugins.js', array(), '20151215', true );
	wp_enqueue_script( 'bootstrap', get_template_directory_uri() . '/assets/js/bootstrap.min.js', array(), '4.0.0', true );
	wp_enqueue_script( '_s-theme', get_template_directory_uri() . '/assets/js/theme.js', array(), '20151215', true );
